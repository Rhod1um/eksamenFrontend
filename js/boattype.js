...
function showUpdateDialog(object){
    ...
    selectedId = object.boatTypeId //"gemmer" id på selected teacher når man trykker update
...
//send PUT
async function update(boatTypeId, name){
    const object = {boatTypeId, name} //husk rigtig id navn når json objekt laves!! ellers 404
...
function showDeleteDialog(object){
    ...
    document.querySelector("#form-delete").addEventListener("submit", function(){
        deleteObject(object.boatTypeId)
    })
}
